...
( test -x "/usr/bin/make" && test -x '/usr/bin/cc' ) || sudo apt-get install build-essential zip unzip bzip2 libssl-dev zlib1g-dev libreadline-dev libexpat-dev libevent-dev libncurses-dev
